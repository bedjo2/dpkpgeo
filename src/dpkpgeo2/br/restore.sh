...
echo "-----------------------------------------------------"
echo "STARTING dpkpgeo2 RESTORE $(date)"
echo "-----------------------------------------------------"
...
SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./dpkpgeo2/br/backup.sh $BKP_FOLDER_NAME/$NEW_UUID
...
echo "-----------------------------------------------------"
echo " - Original Backup of $TARGET_URL --> /$BKP_FOLDER_NAME/$NEW_UUID/"
echo "FINISHED dpkpgeo2 RESTORE $(date)"
echo "-----------------------------------------------------"
