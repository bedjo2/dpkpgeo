...
COPY src /usr/src/dpkpgeo2/
WORKDIR /usr/src/dpkpgeo2
...
RUN chmod +x /usr/src/dpkpgeo2/tasks.py \
    && chmod +x /usr/src/dpkpgeo2/entrypoint.sh
...
# ENTRYPOINT /usr/src/dpkpgeo2/entrypoint.sh
